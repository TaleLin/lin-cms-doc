...
import LinTable from './components/table/LinTable.vue'
import LinButton from './components/button/LinButton.vue'
import LinButtonGroup from './components/button/LinButtonGroup.vue'
import LIcon from './components/icon/LIcon.vue'
...
Vue.component('CourseData', CourseData)
Vue.component('LinTable', LinTable)
Vue.component('LButton', LinButton)
Vue.component('LButtonGroup', LinButtonGroup)
